...
\makeatother
\subtitle{Re: Fragmented markets and the proliferation of small firms:
...
Enclosed please find my report on the paper ``Fragmented markets and the
proliferation of small firms: Evidence from mom-and-pop shops in
Mexico'' by Ramos-Menichelli and Sverdlin-Lisker.
...
\subsection{Important points}\label{important-points}

While I believe the paper is already in high-quality, I wrote down some
major comments in the referee report to further develop the paper. It
mainly talks about some concerns on assumption of the model and request
for elaboration of the institutional settings in developing cities. If
these comments are fully addressed, I strongly believe the paper's
quality will be sufficient to be published in the journal.

\subsection{Recommendation}\label{recommendation}

This is a high-quality paper with a compelling theoretical framework,
rich data, and a thoughtful empirical strategy. Thus I would recommed a
revision. I believe comments in the referee report will further
strengthen an already strong and policy-relevant paper.
