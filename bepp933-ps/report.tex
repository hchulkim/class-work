...
\NormalTok{estim }\OtherTok{\textless{}{-}} \FunctionTok{bunch}\NormalTok{(}
  ...
  \AttributeTok{cf\_start =} \DecValTok{15}\NormalTok{,}
  \AttributeTok{cf\_end =} \DecValTok{13}\NormalTok{,}
  \AttributeTok{exclude\_before =} \DecValTok{9}\NormalTok{,}
  \AttributeTok{exclude\_after =} \DecValTok{4}\NormalTok{,}
