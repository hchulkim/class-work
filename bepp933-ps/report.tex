...
\(\delta = 10\) (Note that since out data is in income bin of width
2,500, this is equivalent to 25,000 difference). Numerically, it will be
...
\NormalTok{estim }\OtherTok{\textless{}{-}} \FunctionTok{bunch}\NormalTok{(}
  ...
  \AttributeTok{cf\_start =} \DecValTok{10}\NormalTok{,}
  \AttributeTok{cf\_end =} \DecValTok{10}\NormalTok{,}
  \AttributeTok{exclude\_before =} \DecValTok{3}\NormalTok{,}
  \AttributeTok{exclude\_after =} \DecValTok{2}\NormalTok{,}
  \CommentTok{\# poly\_size = 2,}
  \AttributeTok{draw =} \ConstantTok{TRUE}\NormalTok{,}
